...
async function runClient() {
    ...
    const animated_login_page_string = await client.iterativePrompt("Ok now give the entire login component an appear animation");
    
    console.log('Chat History:', client.getPromptHistory(4)); // Get last 4 prompt history entry: Last Human prompt and last AI response
    console.log('Webpage History:', client.getPageHistory(4)); // Get last 4 web page generated by chatgpt
}
